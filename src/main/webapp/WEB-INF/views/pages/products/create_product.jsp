        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form:form role="form" action="${pageContext.request.contextPath}/products/save"  modelAttribute="productForm"  method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-sm-2 control-label" >Product Name:</label>
                                <div class="col-sm-8">
                                    <form:input path="name" required="required" size="50" class="form-control"  placeholder="Enter Product Name" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="sku" required="required" size="50" class="form-control"  placeholder="Enter Product SKU" />
                                    <!--  <span id="errlastname" class="alert alert-danger col-lg-8 col-md-8 col-sm-8 col-xs-12">Filed Required.</span>-->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="price" required="required" size="50" class="form-control"  placeholder="Enter Product price" />
                                    <!--  <span id="errlastname" class="alert alert-danger col-lg-8 col-md-8 col-sm-8 col-xs-12">Filed Required.</span>-->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <form:textarea path="description" required="required" class="form-control" placeholder="Enter Category Description" cols="30" rows="3"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="image" class="col-sm-2 col-sm-2 control-label">Image:</label>
                                <div class="col-sm-8">
                                    <form:input type="file"  size="50"  path="image" class="form-control"></form:input>

                                </div>
                            </div>

                            <div class="form-group">
                                <label for="description" class="col-sm-2 col-sm-2 control-label"> Select Category ID:</label>
                                <div class="col-sm-8">
                                    <form:select id="categoryId" name="categoryId" class="form-control" required="required" path="categoryId">
                                        <form:option value=""> Select Categories</form:option>
