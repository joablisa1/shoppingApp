        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form:form role="form" action="${pageContext.request.contextPath}/categories/save"
                                   modelAttribute="category" method="post" autocomplete="off">
                            <form:hidden path="id"/>
                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-sm-2 control-label"> Category Name:<span
                                        class=" alert-danger">*</span> </label>
                                <div class="col-sm-8">
                                    <form:input path="name" required="required" class="form-control" placeholder="Enter Category Name"/>
                            ...
                            <div class="form-group">
                                <label for="displayOrder" class="col-sm-2 col-sm-2 control-label">Display Order:<span
                                        class="alert-danger">*</span></label>
                                <div class="col-sm-8">
                                    <form:input path="displayOrder" required="required" class="form-control"
