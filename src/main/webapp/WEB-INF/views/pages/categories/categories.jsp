    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class=" mb-2 text-gray-800  font-weight-normal text-sm-right">Category List</h3>
                <p class="mb-4"><a href="${pageContext.request.contextPath}/categories/new" class="mr-auto btn btn-outline-success"><span class="fa fa-plus"></span> Add Category </a></p>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h5 class="m-0  font-weight-lighter text text-primary">Create Category</h5>
                    </div>
                    <div class="card-body">
